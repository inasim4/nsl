...
import { FaFacebook, FaYoutube, FaGithub, FaTwitch } from "react-icons/fa";
  ...
  return (
    <main
      ...
      <footer className="text-center text-gray-600 dark:text-gray-400 text-sm mt-8">
        &copy; {currentYear} NSL. All rights reserved.
      </footer>
    </main>
  );
}
